...
public class Marks extends JFrame implements ActionListener{
	...
	public Marks(String rollno) {
		...
		JLabel heading = new JLabel("Mumbai Technical University");
		...
		JLabel lblrollno = new JLabel("Roll Numbar "+ rollno);
		lblrollno.setBounds(60, 100, 500, 20);
		lblrollno.setFont(new Font("Tahoma", Font.PLAIN, 20));
		add(lblrollno);
		
		JLabel lblsememster = new JLabel();
		lblsememster.setBounds(60, 130, 500, 20);
		lblsememster.setFont(new Font("Tahoma", Font.PLAIN, 18));
		add(lblsememster);
		...
		try {
			...
			while(rs2.next()) {
				...
				lblsememster.setText("Semester: "+rs2.getString("semester"));
